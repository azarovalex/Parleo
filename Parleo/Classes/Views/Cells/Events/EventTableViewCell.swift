...
class EventTableViewCell: UITableViewCell {
    ...
    var viewModel: EventTableCellViewModel? {
        didSet {
            ...
            backgroundImageView.kf.setImage(with: viewModel.backgroungImageURL, placeholder: R.image.avatarTemplate()!)
...
private extension EventTableViewCell {
    enum Constants {
        enum Font {
            static let titleLabel = R.font.montserratRegular(size: 30)
            static let descriptionLabel = R.font.montserratRegular(size: 13)
        }
    }
}
