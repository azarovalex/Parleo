...
private extension Selector {
    static let buttonTapped = #selector(DatePickerAlert.buttonTapped)
    static let deviceOrientationDidChange = #selector(DatePickerAlert.deviceOrientationDidChange)
}

open class DatePickerAlert: UIView {
    ...
    public init(textColor: UIColor = UIColor.black,
                buttonColor: UIColor = #colorLiteral(red: 0, green: 0.4784313725, blue: 1, alpha: 1),
